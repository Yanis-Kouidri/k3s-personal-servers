...
```bash
0 3 * * * /home/ubuntu/k3s-personal-servers/backups/general_pvc_backup.sh -n immich -N immich-server -p server-immich-pvc >> /home/ubuntu/backups/immich/backup-immich-server.log 2>&1
```